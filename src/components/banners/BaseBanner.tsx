      ...
      {children ? (
        ...
        <div className="container-fluid h-100 flex-grow-1 p-0 d-flex flex-column">
          ...
          <div className="row g-2 g-md-4 align-items-center flex-grow-1 h-100">
            ...
            <div className={`col-12 col-sm-5 d-flex flex-column justify-content-center h-100 ${styles.leftCol}`}>
            ...
            <div className={`col-12 col-sm-7 d-flex align-items-center justify-content-center h-100 ${styles.rightCol}`}>
